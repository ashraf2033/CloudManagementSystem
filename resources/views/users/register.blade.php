			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/users') }}">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">الدور</label>
							<div class="col-md-6">

							{!! Form::select('role',[''=>'إختر','مشرف'=>'مشرف','قسم الصيانة'=>'قسم الصيانة','قسم الإنتاج'=>'قسم الإنتاج','مدير'=>'مدير'],null,['class' => 'form-control']) !!}
							</div>
						</div>
