                    ...
                    <div class="tab-pane" id="tab_3-1">
                      ...
                      <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><a href="{{ action("RepairsController@show",[$repairMonth,'action'=>'RepairsController@finish'])}}">{{$repairMonth->rep_id}}</a></td>
                    ...
                    <div class="tab-pane" id="tab_3-2">
                      ...
                      <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><a href="{{ action("RepairsController@show",[$repairWeek,'action'=>'RepairsController@finish'])}}">{{$repairWeek->rep_id}}</a></td>
