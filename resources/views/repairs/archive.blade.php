...
<div class="col-xs-12">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="class = box-title">إصلاحات معتمدة</h3>
    </div>
<div class="box-body">
<div class="row">
...
<td>
  <a href="{{ action("RepairsController@show",[$repair,'action'=> 'RepairsController@show']) }}" title="تفاصيل" aria-label="Left Align" type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-question-sign " aria-hidden="true"></span></a>
